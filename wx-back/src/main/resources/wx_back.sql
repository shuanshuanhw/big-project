...
insert into sys_work(work_id,work_name,worker_id,work_introduce,work_sort) values (1,'青花瓷',1,'青花瓷（blue and white porcelain），又称白地青花瓷，常简称青花，是中国瓷器的主流品种之一，属釉下彩瓷。青花瓷是用含氧化钴的钴矿为原料，在陶瓷坯体上描绘纹饰，再罩上一层透明釉，经高温还原焰一次烧成。',1);
insert into sys_work(work_id,work_name,worker_id,work_introduce,work_sort) values (2,'鸟嘴医生',1,'他们身穿黑色长袍，手持一根长木棍，头戴一顶黑色宽檐帽，将整个头藏进去。长嘴的猛禽造型，覆盖着佩戴者的口鼻，鸟嘴长度可达到30厘米，长嘴两侧靠近鼻子的位置有两个孔，这样阴森恐怖的外型让人不寒而栗，很多人认为他是瘟疫和死神的象征。',2);
insert into sys_work(work_id,work_name,worker_id,work_introduce,work_sort) values (3,'救世主',1,'达芬奇如何天才一生自是不必多说，作为这位天才画家唯一可以出售的作品，《救世主》于纽约时间2017年11月15日晚间，以4亿美元落槌，最终成交价为4.50312亿美元(约人民币29.577亿元)价格在纽约佳士得夜拍上成交，整个拍卖仅持续了20分钟，它成为史上最贵的艺术品。',3);
insert into sys_work(work_id,work_name,worker_id,work_introduce,work_sort) values (4,'阿尔及尔的女人',2,'被誉为“现代艺术创始人”的毕加索，以超现实主义、超立体主义的抽象画作风格而闻名，而这幅《阿尔及尔的女人》可谓是其艺术生涯中里程碑式的作品，也是毕加索本人最钟情的一幅画。',4);
insert into sys_work(work_id,work_name,worker_id,work_introduce,work_sort) values (5,'侧卧的裸女',2,'20世纪意大利超现实主义画家莫迪利亚尼擅长以颜色浓烈的色块和夸张的形体塑造人物，而这幅《侧卧的裸女》是他的代表作之一。',5);
insert into sys_work(work_id,work_name,worker_id,work_introduce,work_sort) values (6,'卢西恩·弗洛伊德肖像画习作',2,'《卢西恩·弗洛伊德肖像画习作》是英国表现主义画家弗朗西斯·培根与1969年为他的好友兼对手卢西恩·弗洛伊德所画，被认为是培根最伟大的作品。2013年11月12日在纽约佳士得拍卖会上以1.424美元的价格成交。',6);
insert into sys_work(work_id,work_name,worker_id,work_introduce,work_sort) values (7,'指示者',3,'《指示者》是瑞典超表现主义画家、雕塑家贾科梅蒂的代表作之一，这个雕塑造型目前仍在很多现代风格装饰品中所见。2015年5月11日，由佳士得拍卖会以1.41亿美元的价格拍售成功。',7);
insert into sys_work(work_id,work_name,worker_id,work_introduce,work_sort) values (8,'呐喊',3,'对于早已火成表情包的《呐喊》与蒙克的知名度，甚至不用多做介绍。同为表现主义画家的蒙克，擅长用流动的线条与强烈的色彩表现画作的情绪，比如呐喊所表现的恐惧，透过画作扑面而来。',8);
insert into sys_work(work_id,work_name,worker_id,work_introduce,work_sort) values (9,'无题',3,'二战时期，作为一个生活在白人统治国家中的美国黑人涂鸦艺术家，巴斯奎特的涂鸦作品看似毫无章法，其实都代表了他对当时的政治、社会、宗教的理性思考，被誉为“新艺术代表人物”，其代表作《无题》于2017年5月18日，在纽约苏富比拍出约1.1亿美元。',9);
...
(
    ...
    photo_url      varchar(50)     not null                   comment '图片地址',
...
insert into sys_worker(worker_id, worker_name, worker_sex, worker_age, worker_phone, worker_nickname, worker_account, worker_password) values (1,'算算','1',35,'15007572525','牛人','shuanshuan',AES_ENCRYPT('651392qQ','shuanshuan'));
insert into sys_worker(worker_id, worker_name, worker_sex, worker_age, worker_phone, worker_nickname, worker_account, worker_password) values (2,'黄维','1',35,'15007572525','牛人','shuanshuan',TO_BASE64(AES_ENCRYPT('651392qQ','shuanshuan')));
insert into sys_worker(worker_id, worker_name, worker_sex, worker_age, worker_phone, worker_nickname, worker_account, worker_password) values (3,'黄算算','1',35,'15007572525','牛人','shuanshuan',TO_BASE64(AES_ENCRYPT('651392qQ','shuanshuan')));
